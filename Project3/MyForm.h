...
private: String^ CorFilename;// им€ файла с ответом
private: int CorFilenum; // его номер

	   //функции
private: void Game();// игра
private: void RandomPicture();// картинка правильна€
private: String^ RandomPictureNameF(); // неправильна€ с рандомным число -
private: String^ RandomPictureNameS();// неправильна€ с рандомным число -
private: String^ RandomPictureNameT();// неправильна€ с рандомным число -
